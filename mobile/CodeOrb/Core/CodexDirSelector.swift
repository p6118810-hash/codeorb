//
//  CodexDirSelector.swift
//  CodeOrb
//
//  Manages the expand/collapse state of the Codex directory picker row,
...
@MainActor
class CodexDirSelector: ObservableObject {
    static let shared = CodexDirSelector()
