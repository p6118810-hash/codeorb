...
private let logger = Logger(subsystem: "com.codeorb", category: "Interrupt")
...
class JSONLInterruptWatcher {
    ...
    private let queue = DispatchQueue(label: "com.codeorb.interruptwatcher", qos: .userInteractive)
    ...
    init(sessionId: String, cwd: String) {
        ...
        self.filePath = CodexPaths.projectsDir.path + "/" + projectDir + "/" + sessionId + ".jsonl"
    }
