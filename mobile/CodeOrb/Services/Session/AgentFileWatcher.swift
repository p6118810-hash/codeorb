...
private let logger = Logger(subsystem: "com.codeorb", category: "AgentFileWatcher")
...
class AgentFileWatcher {
    ...
    private let queue = DispatchQueue(label: "com.codeorb.agentfilewatcher", qos: .userInitiated)
