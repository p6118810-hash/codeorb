...
//  CodeOrb
//
//  Handles Codex tool approval operations via tmux
//

import Foundation
import os.log

/// Handles tool approval and rejection for Codex instances
actor ToolApprovalHandler {
    ...
    nonisolated static let logger = Logger(subsystem: "com.codeorb", category: "Approval")
