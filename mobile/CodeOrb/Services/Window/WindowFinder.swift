...
actor WindowFinder {
    ...
    /// Find a primary window for a terminal when a dedicated tmux window is unavailable.
    nonisolated func findPrimaryWindow(forTerminalPid pid: Int, windows: [YabaiWindow]) -> YabaiWindow? {
