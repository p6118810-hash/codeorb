...
//  CodeOrb
//
//  Explicit state machine for Codex session lifecycle.
...
enum SessionPhase: Sendable {
    ...
    /// Codex is actively processing (running tools, generating response)
    case processing

    /// Codex has finished and is waiting for user input
    ...
    nonisolated func canTransition(to next: SessionPhase) -> Bool {
        ...
        case (.waitingForApproval, .waitingForInput):
            return true  // Denied and Codex stopped
